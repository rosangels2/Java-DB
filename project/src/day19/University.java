...
/*		학생 한명의 정보를 만들고 정보에 과목을 추가한 뒤 평점을 확인
		Student std = new Student("최진영", "강화대교", "2019101000", "무화과", 0.0);
		System.out.println(std);
		std.insertSubject(new Grade("A+", "홍길동", "풋사과", 3));
		System.out.println(std);
		std.insertSubject(new Grade("B+", "임꺽정", "한과", 2));
		System.out.println(std);
		std.insertSubject(new Grade("A",  "유관순", "청사과", 3));
		System.out.println(std);		
*/			
