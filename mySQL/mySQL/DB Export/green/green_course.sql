...
CREATE TABLE `course` (
  ...
  `give_up` varchar(1) NOT NULL DEFAULT 'N',
  PRIMARY KEY (`no`),
  KEY `class_no_idx` (`no`),
  KEY `class_no_idx1` (`class_no`),
...
INSERT INTO `course` VALUES (0,2,201910102,'N'),(1,2,201910103,'N'),(2,2,201910103,'N'),(3,1,201910101,'N'),(4,1,201910101,'N'),(5,2,201910101,'N');
...
-- Dump completed on 2019-07-08 16:56:55
