...
*/		
		...
		/*문제5) 지금까지 먹은 밥값을 계산하여 결과를 출력하시오
		 * 단 하루에 3끼를 꼭 먹고 한 끼에 3000원이다.
		 * 개월은 무시하고 나이로만 계산, 윤년은 무시 */
